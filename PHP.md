...
3. **你做过印象最深刻,最有难度的项目是哪个? 遇到了什么问题,有什么难点? 使用了什么技术(问的最多的)**
...
7. **如何定位日志中500 错误? 列举了日志的具体内容**



8. **禁用cookie之后 session还可以用吗？**
...
10. **做过分表吗?怎么分的呢?**
     ...
     根据 uid hash 水平分表一般都这样

11. **写一段程序, 返回数组, 往右移动, 两个数相减差最大的值. 比如 [3, 5, 16, 1, 2, 5]  返回15**
